...
public class EquipmentController {
    ...
    public EquipmentController(@Qualifier("jpaEquipmentService") EquipmentService equipmentService) {
    ...
    @GetMapping(value = "/by-equip-type/{equipType}")
    public ResponseEntity<List<EquipmentListDto>> equipmentsByEquipType(@PathVariable @Size(min = 3, max = 255) String equipType) {
        return ResponseEntity.ok(equipmentService.findByEquipType(equipType));
    }
